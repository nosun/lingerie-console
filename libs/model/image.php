<?php
class Image_Model extends MD_Model
{
  /**
   * @return Image_Model
   */
	...
	public function uploadImage($sn){
		$options = array();
		if($sn != ''){
			$options['upload_dir'] = dirname($_SERVER['SCRIPT_FILENAME']).'/files/'.$sn.'/';
			$options['upload_url'] = $this->get_full_url().'/files/'.$sn.'/';
		}
