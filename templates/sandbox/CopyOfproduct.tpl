...
<td class="f-serial"><input name="sn_filter" type="text" value="SN" onblur="if(this.value==''){this.value='SN';}" onfocus="if(this.value=='SN'){this.value='';}"/></td>
<td class="f-name"><input name="name_filter" type="text" style="background-color:#dddddd;color:#999;" value="In Development...." readonly/></td>
<td class="f-type"><input name="type_filter" type="text" value="TYPE" onblur="if(this.value==''){this.value='TYPE';}" onfocus="if(this.value=='TYPE'){this.value='';}"/></td>
<td class="f-weight"><input name="weight_filter" type="text" value="WEIGHT" onblur="if(this.value==''){this.value='WEIGHT';}" onfocus="if(this.value=='WEIGHT'){this.value='';}"/></td>
<!--
<td class="f-colors"><input name="color_filter" type="text" value="COLOR" onblur="if(this.value==''){this.value='COLOR';}" onfocus="if(this.value=='COLOR'){this.value='';}"/></td>
<td class="f-sizes"><input name="size_filter" type="text" value="SIZE" onblur="if(this.value==''){this.value='SIZE';}" onfocus="if(this.value=='SIZE'){this.value='';}"/></td>
  -->
...
<dd>编号: <?php echo $v->sn;?></dd>
<dd>颜色集：<?php echo $v->colors;?></dd>
<dd>大小集：<?php echo $v->colors;?></dd>
