...
<form id="orderfilter" name="orderfilter" method="post" action="<?php echo url('order/ordersearch');?>">
<table class="filter">

<tbody>
<tr id="order-filter" style="background-color:#ffeeff">
<th class="filter-cell"><b>查询：</b></th>
...
<td class="f-delivery_email w100"><input type="text" name="delivery_email_filter" value="<?php echo isset($filters['delivery_email'])? $filters['delivery_email']:'客户Email'?>" onblur="if(this.value==''){this.value='客户Email';}" onfocus="if(this.value=='客户Email'){this.value='';}"/></td>
...
<td >
	<input type="submit" name="apply_filters" class="button filter_order" value="搜索订单"/>
</td>
</tr>
</tbody>
</table>
